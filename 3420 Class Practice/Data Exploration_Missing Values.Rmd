...
Missing values should be coded as NAs. Some missing values may not be correctly recorded. For example, it is natural to code missing strings as "" rather than NAs. In order for us to properly deal with missing values, we need to make sure that missing values are correctly coded as NAs.
