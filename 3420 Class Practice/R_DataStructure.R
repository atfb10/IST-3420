...
v1[5]  # Access the 5th element (out of current range)
...
m5 <- diag(1,3)  # Create a 3X3 matrix with a diagonal of ones, i.e., a 3X3 identity matrix
m5
...
a1*i1  # Element-wiase multiplication
